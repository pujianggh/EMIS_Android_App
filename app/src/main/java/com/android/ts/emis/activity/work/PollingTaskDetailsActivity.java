...
public class PollingTaskDetailsActivity extends BaseActivity {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        if (bean != null)
            setTitleBarLayout(R.drawable.icon_back_white_bar, bean.getPollName(), null, "同步", true);
    ...
    private void initData() {
        btnTabLeft.setText("全部(3)");
        btnTabCenter.setText("完成(2)");
        btnTabRight.setText("未完成(1)");
